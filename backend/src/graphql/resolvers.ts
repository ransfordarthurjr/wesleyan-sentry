...
export const resolvers = {
  Query: {
    ...
    members_marital_statuses: async (parent: any, args: any, context: any) => {
      const prisma: PrismaClient = context.prisma;
    ...
    members_occupation_by_id: async (parent: any, args: any, context: any) => {
      const prisma: PrismaClient = context.prisma;
    ...
    members_tithes_payments: async (parent: any, args: any, context: any) => {
      const prisma: PrismaClient = context.prisma;
